...
import { type ContactForm } from "@/schemas/contactForm.schema";
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    {fields.map((field, index) => (
                        <div key={field.id} className="my-12 border border-solid max-w-xl">
                            <RouteOptions
                                index={index}
                    ...
                    <div className=" justify-center">
                        <Button type="button" variant={"outline"} onClick={previousPage}>
                            Previous
                        </Button>
                        <Button
                            type="button"
